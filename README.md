...
This is a clone of Apple's iPhone 15 Pro website with an additional Macbook page using React.js and TailwindCSS. It highlights the effective use of GSAP (Greensock Animations) and Three.js for displaying iPhone 15 Pro models in various colors and shapes.
...
👉 **Additional MacBook Page**: integrated a dedicated Mac page which includes 3D MacBook model with an interactive image carousel using React and Three.js.
...
```bash
https://github.com/MeetMavani/Apple_website.git
cd Apple_website
```
